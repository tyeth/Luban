...
mcp/
  ...
  probeTracePerimeter.ts probe_trace_perimeter: 0.1 mm crawl round an unknown pocket (perimeterTrace.ts pure: crawl with a release-verified standoff, rub handling, selective confirm cycles, partial result on abort, segmentation, T8-measured time estimate)
